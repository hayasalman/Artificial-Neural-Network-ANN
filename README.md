...
- Performed exploratory data analysis (EDA) : univariate analysis, and bivariate analysis that will help us to describe and summarize the dataset characteristics, identify associations between 
  the variables, discover insights , or detect the if there are any abnormalities in this dataset , and recognize any kind of patterns within the dataset that will help us to identify which 
...
[Bank's Customers Churn Prediction IPYNB File](https://github.com/hayasalman/Artificial-Neural-Network-ANN/blob/main/Customers_Churn_ANN_Notebook_.ipynb)
